...
var useEditorWithJQuery = (function () {
    ...
    var useEditorWithJQuery = ($, doka) => {
        ...
        const { appendEditor, appendDefaultEditor, isSupported, dispatchEditorEvents } = doka;
        ...
        $.fn.doka = createFactory(appendEditor);

        $.fn.dokaDefault = createFactory(appendDefaultEditor);
