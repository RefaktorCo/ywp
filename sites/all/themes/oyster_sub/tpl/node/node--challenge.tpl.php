<?php 
  ...
  if (isset($node->field_from_workshop['und'][0])) {
	  if ($node->field_from_workshop['und'][0]['value'] == '1') {
		  $workshop = true;
	  }
  }  
...
<?php if ($teaser && $workshop == true): ?>

<div class="shortcode_tab_item_title expand_no"><?php print $title; ?></div>
<div class="shortcode_tab_item_body tab-content clearfix">
  <div class="ip">
	  <?php print render($content['field_challenge_summary']); ?>
	  <a href="<?php print $node_url; ?>" class="shortcode_button btn_small btn_type5"><?php print t('View'); ?></a>
	  
	  <?php if ($group == TRUE): ?>
	  <a href="<?php print $base_url; ?>/node/add/blog?field_workshop_challenge=<?php print $node->nid; ?>" class="respond shortcode_button btn_small btn_type5"><?php print t('Respond'); ?></a>
	  <?php endif; ?>
